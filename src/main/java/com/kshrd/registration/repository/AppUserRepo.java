...
//    AppUser addNewUser(@Param("user") AppUserReq userReq);
    ...
    @Select("INSERT INTO app_user(id, email, password, token) " +
            "VALUES(#{id}, #{user.email}, #{user.password}, #{token}) RETURNING *")
    ...
    AppUser addNewUser(@Param("user") EmailPasswordReq userReq, String token, String id);
    ...
    void addUserInRoleUSER(String userId);
