...
//                AppUser user = appUserRepository.getUserByEmail(email.getEmail());
                ...
                String myID = GenerateId.id();
                AppUser user = appUserRepository.addNewUser(userReq, uuid, myID);
                System.out.println("NEW USER1: " + user);
                ...
                appUserRepository.addUserInRoleUSER(myID);
